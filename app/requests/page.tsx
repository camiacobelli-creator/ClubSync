...
export default function RequestsPage() {
  ...
  async function handleAcceptConfirmation(r: GameRequest) {
    ...
    // Also flip the requester's own board to scheduled — matters when they
    // asked about an open/busy day rather than one already marked scheduled.
    ...
    setConfirming(null);
    if (err1 || err1b || err2) {
      setError((err1 || err1b || err2)?.message ?? "Something went wrong.");
      return;
    }
    reload();
  }
